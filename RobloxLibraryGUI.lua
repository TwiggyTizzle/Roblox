...
if CoreGui:FindFirstChild("TwiggyTizzle") then
    CoreGui.TwiggyTizzle:Destroy()
...
if not isfolder("TwiggyTizzle") then
...
makefolder("TwiggyTizzle")
    
local Circle = request({Url = "https://raw.githubusercontent.com/TwiggyTizzle/Icons/main/Circle.png", Method = "GET"})
writefile("TwiggyTizzle/Circle.png", Circle.Body)
dText.Text = "Downloaded: Circle.png"
    
local ColorDropper = request({Url = "https://raw.githubusercontent.com/TwiggyTizzle/Icons/main/ColorDropper.png", Method = "GET"})
writefile("TwiggyTizzle/ColorDropper.png", ColorDropper.Body)
dText.Text = "Downloaded: ColorDropper.png"

local Close = request({Url = "https://raw.githubusercontent.com/TwiggyTizzle/Icons/main/Close.png", Method = "GET"})
writefile("TwiggyTizzle/Close.png", Close.Body)
dText.Text = "Downloaded: Close.png"

local CollapseArrow = request({Url = "https://raw.githubusercontent.com/TwiggyTizzle/Icons/main/CollapseArrow.png", Method = "GET"})
writefile("TwiggyTizzle/CollapseArrow.png", CollapseArrow.Body)
dText.Text = "Downloaded: CollapseArrow.png"
    
local RadioButton = request({Url = "https://raw.githubusercontent.com/TwiggyTizzle/Icons/main/RadioButton.png", Method = "GET"})
writefile("TwiggyTizzle/RadioButton.png", RadioButton.Body)
dText.Text = "Downloaded: RadioButton.png"
    
local RadioOuter = request({Url = "https://raw.githubusercontent.com/TwiggyTizzle/Icons/main/RadioOuter.png", Method = "GET"})
writefile("TwiggyTizzle/RadioOuter.png", RadioOuter.Body)
dText.Text = "Downloaded: RadioOuter.png"
    
local RadioInner = request({Url = "https://raw.githubusercontent.com/TwiggyTizzle/Icons/main/RadioInner.png", Method = "GET"})
writefile("TwiggyTizzle/RadioInner.png", RadioInner.Body)
...
Info.Text = Info.Text or "TwiggyTizzle"

local window = {}

local TwiggyTizzleScreenGui = Instance.new("ScreenGui")
TwiggyTizzleScreenGui.Name = "TwiggyTizzle"
TwiggyTizzleScreenGui.Parent = CoreGui
...
main.Parent = TwiggyTizzleScreenGui
...
closeButton.Image = getcustomasset("TwiggyTizzle/Close.png")
...
editButton.Image = getcustomasset("TwiggyTizzle/ColorDropper.png")
...
circleIcon.Image = getcustomasset("TwiggyTizzle/Circle.png")
...
dropdownIcon.Image = getcustomasset("TwiggyTizzle/CollapseArrow.png")
...
radioButtonIcon.Image = getcustomasset("TwiggyTizzle/CollapseArrow.png")
...
radioButtonIcon2.Image = getcustomasset("TwiggyTizzle/RadioButton.png")
...
radioOuter.Image = getcustomasset("TwiggyTizzle/RadioOuter.png")
...
radioInner.Image = getcustomasset("TwiggyTizzle/RadioInner.png")
